...
export class StuPrePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public http :Http) {
    this.urlQuesAll="http://47.100.203.126:81/index.php/demo/index/getquesbyexamid";
    this.urlQuesRight="http://47.100.203.126:81/index.php/demo/index/getQuesRight";
    this.urlQuesWrong="http://47.100.203.126:81/index.php/demo/index/getQuesWrong";

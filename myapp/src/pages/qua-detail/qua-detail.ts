...
export class QuaDetailPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private  http: Http) {
    ...
    this.urlQuesDetail="http://47.100.203.126:81/index.php/demo/index/getQuesDetail";
    this.urlGetSubtitle="http://47.100.203.126:81/index.php/demo/index/getKnowledgeByTitleId";
    this.urlQuesMessage="http://47.100.203.126:81/index.php/demo/index/getQuesMessage";
  ...
  ionViewDidLoad() {
    ...
    // this.http.request('http://47.100.203.126:81/index.php/index/requestMess')

...
export class HomeworkForStudentPage
{
  ...
  {
    this.urlQuesAll="http://47.100.203.126:81/index.php/demo/index/getQuesByHomeworkName";
    this.urlQuesRight="http://47.100.203.126:81/index.php/demo/index/getHomeworkRight";
    this.urlQuesWrong="http://47.100.203.126:81/index.php/demo/index/getHomeworkWrong";

...
/**
 * Generated class for the StuParcticeDetailPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-stu-parctice-detail',
  templateUrl: 'stu-parctice-detail.html',
})
export class StuParcticeDetailPage {

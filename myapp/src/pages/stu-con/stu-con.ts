...
export class StuConPage {
 ...
 test:string;
  constructor(public navCtrl: NavController, public navParams: NavParams,public http :Http) {
    ...
    this.urlGetStuPracticeMark="http://47.100.203.126:81/index.php/demo/index/getStuPracticeMark";
    this.urlGetHomeworkList="http://47.100.203.126:81/index.php/demo/index/getHomeworkList";
    this.urlGetStuHomeworkMark="http://47.100.203.126:81/index.php/demo/index/getStuHomeworkMark"
